...
4. Cada algoritmo retorna tanto el camino como el orden de exploración, lo que facilita la visualización comparativa del comportamiento de cada estrategia.